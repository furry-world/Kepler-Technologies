...
|NPLOAD|010100 xxx0cc cccccc | set value of register to value from program memory at address decoded from work memory | 6 cycles|
|NPSTORE|010101 xxx0cc cccccc | store value of register to program memory at address decoded from work memory | 6 cycles|
