...
```
#### Description:
Stores the value in the specified register at a specified memory address.
...
```
#### Description:
Stores the value in the specified register at a specified program memory address.
